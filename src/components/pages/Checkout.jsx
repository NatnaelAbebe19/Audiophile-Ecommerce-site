    ...
    <div className="flex flex-col lg:flex-row bg-slate-100  items-center lg:items-start max-w-[1120px] mx-auto ">
        <div className='w-[95%] shadow-slate-600 m-4 rounded-md bg-[#fff] px-4 py-6 lg:w-[60%] lg:mb-16'>
            ...
            <div className='flex justify-between gap-x-4 flex-col md:flex-row'>
                <div className="flex flex-col w-full md:w-[50%]">
                    ...
                    <input type='text' name='name' id="name" autoComplete='given-name' className='w-full border-2 p-4 rounded-xl' placeholder="Natnael Abebe"/>
                </div>
                <div className="flex flex-col md:w-[50%]">
                    <label htmlFor="email"  className='font-bold text-[md] my-3'>Email address</label>
                    <input type="text" name='email' id="email" autoComplete='email' className='w-full border-2 p-4 rounded-xl' placeholder="nati@gmail.com"/>
                </div>
            </div>
            <div className="flex flex-col w-full md:w-[50%]">
                <label htmlFor="phone"   className='font-bold text-[md] my-3'>Phone Number</label>
                <input type="tel" placeholder='+1 202-555-0136' id='phone' name='phone' autoComplete='on' className='w-full border-2 p-4 rounded-xl'/>
            </div>
            ...
            <div className="flex flex-col">
                ...
                <input type="text" id='address' placeholder='1137 williams avenue'  name='address' autoComplete='on' className='w-full border-2 p-4 rounded-xl'/><br/>
            </div>
            <div className='flex justify-between gap-x-4 flex-col md:flex-row'>
                <div className="mb-4 w-full md:w-[50%]">
                    <label htmlFor="zipCode" className='font-bold text-[md] mb-4'>ZIP Code</label>
                    <input type="text" name='zipCode'  className='w-full border-2 p-4 rounded-xl' placeholder='10001' autoComplete='on' id='zipCode' />
                </div>
                <div className="mb-4 w-full md:w-[50%]">
                    <label htmlFor="city" className='font-bold text-[md] mb-4'>City</label>
                    <input type="text" name='city' placeholder='New York'  className='w-full border-2 p-4 rounded-xl' autoComplete='on' id="city"/>
                </div>
            </div>
            <div className='w-full md:w-[50%]'>
                <label htmlFor="country" className='font-bold text-[md] my-3 '>Country</label>
                <input type="text" name='country' placeholder='United States'  className='w-full border-2 p-4 rounded-xl' id="country"  autoComplete='on'/>
            </div>
            ...
            <div className='flex flex-col justify-between md:flex-row'>
                ...
                <div className='flex flex-col gap-y-4 mb-6 items-center w-full md:w-[50%]'>
                    <div className="flex w-full gap-x-4 border-2 p-2 rounded-xl">
                        <input type='radio' id='e-Money' name='cash'  className='w-5 bg-[#D87D4A]' value="option2" checked={selectedOption === 'option2'} autoComplete='on' onChange={handleOptionChange}/>
                    ...
                    <div className="flex w-full border-2 p-2 gap-x-4 rounded-xl">
                        <input type='radio' style={{ '--radio-color': '#D87D4A' }} id='e-Money2'  autoComplete='on' name='cash'  className='w-5 bg-[#D87D4A]' value="option1" checked={selectedOption === 'option1'} onChange={handleOptionChange}/>
                        <label htmlFor="e-Money2" className='font-bold text-[md] my-3'>Cash on delivery</label>
                    </div>
                </div>
            </div>
            ...
            {selectedOption === 'option2' && <div className='flex flex-col md:flex-row gap-x-4'>
                <div className='mt-6 w-full md:w-[50%]'>
                    ...
                    <input type="text" placeholder='238521993' className='w-full border-2 p-4 rounded-xl' id='eMoneyNum'  autoComplete='on'/>
                </div>
                <div className='mt-6 w-full md:w-[50%]'>
                    <label htmlFor='eMoneyPin'  className='font-bold text-md mb-3'>e-Money PIN</label>
                    <input type="text"  placeholder='0674' className='w-full border-2 p-4 rounded-xl' id='eMoneyPin'  autoComplete='on'/>
                </div>
            </div>}
        </div>
        <div className='w-[95%] shadow-slate-600 m-4 rounded-md bg-[#fff] px-6 py-6 mb-20  lg:w-[40%]'>
            ...
            <div className="flex flex-col">
                <div>
                    {cartItems.map(items=>(
                    <div className="flex justify-between my-5" key={items.id}>
